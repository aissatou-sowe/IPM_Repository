...
var IPM_Bon_Consultation = /** @class */ (function (_super) {
    ...
    motif, ipm_conjoint) {
        var _this = _super.call(this, idbon, total, ipm_employe, ipm_prestataire, ipm_enfant, ipm_conjoint, ipm_prestation) || this;
        _this.idbon = idbon;
...
var BonLettreComponent = /** @class */ (function () {
    ...
    function BonLettreComponent(emp_service, router, pres_service, bont, route, conj_service, bon_lettreService, enf_service, toastr, datePipe) {
        ...
        this.b = new src_app_Models_IPM_Bon__WEBPACK_IMPORTED_MODULE_11__["IPM_Bon"](0, "", null, null, null, null, null);
        this.bonlettre = new src_app_Models_IPM_Bon_Lettre_Garantie__WEBPACK_IMPORTED_MODULE_12__["IPM_Bon_Lettre_Garantie"](0, "", "", "", null, null, null, null, null, null);
...
var BonConsultationComponent = /** @class */ (function () {
    function BonConsultationComponent(emp_service, router, pres_service, route, conj_service, enf_service, datePipe, Serviceprestation, bon_lettreService) {
        ...
        this.bonlettre = new _Models_IPM_Bon_Consultation__WEBPACK_IMPORTED_MODULE_15__["IPM_Bon_Consultation"](0, "", "", "", "", null, null, null, null, null, null, null, null, null);
        this.desactive = false;
    }
...
var IPM_Bon_Pharmaceutique = /** @class */ (function (_super) {
    ...
    //public date_etablissement:Date,
    quantite, designation, prix_unitaire, ipm_employe, ipm_prestataire, ipm_enfant, ordonnance, ipm_conjoint, ipm_prestation, numero_bon_pharmacie) {
        var _this = _super.call(this, idbon, total, ipm_employe, ipm_prestataire, ipm_enfant, ipm_conjoint, ipm_prestation) || this;
        _this.idbon = idbon;
        _this.nombre_article = nombre_article;
        _this.service = service;
...
var AjoutBonsComponent = /** @class */ (function () {
    function AjoutBonsComponent(emp_service, fb, router, bon_service, conj_service, enf_service, route, pres_service, bonpharma) {
        ...
        //bon:any
        this.bon = new src_app_Models_IPM_Bon_Pharmaceutique__WEBPACK_IMPORTED_MODULE_7__["IPM_Bon_Pharmaceutique"](0, 0, null, "", null, null, "", null, null, null, null, null, null, "");
        //  public makePDF():void{
...
var IPM_Bon_Lettre_Garantie = /** @class */ (function (_super) {
    ...
    function IPM_Bon_Lettre_Garantie(idbon, total, categorie_hospitalisation, motif, ipm_employe, ipm_prestataire, ipm_enfant, ordonnance, ipm_conjoint, ipm_prestation) {
        var _this = _super.call(this, idbon, total, ipm_employe, ipm_prestataire, ipm_enfant, ipm_conjoint, ipm_prestation) || this;
        _this.idbon = idbon;
        _this.total = total;
...
var BonLunetterieComponent = /** @class */ (function () {
    function BonLunetterieComponent(emp_service, router, pres_service, route, conj_service, enf_service, datePipe, bon_lettreService) {
        ...
        this.conjoints = [];
        this.currentemploye = new src_app_Models_Employe__WEBPACK_IMPORTED_MODULE_7__["Employe"]();
        this.bonlettre = new src_app_Models_IPM_Bon_Lunetterie__WEBPACK_IMPORTED_MODULE_9__["IPM_Bon_Lunetterie"](0, null, null, null, null, null, null, null, null, null, null, null);
    }
...
var IPM_Bon = /** @class */ (function () {
    function IPM_Bon(idbon, total, ipm_employe, ipm_prestataire, ipm_enfant, ipm_conjoint, ipm_prestation) {
        this.idbon = idbon;
        this.total = total;
...
var ListeBonsComponent = /** @class */ (function () {
    function ListeBonsComponent(dateform, emp_service, router, route, pres_service, bonpharma, bont, conj_service, enf_service, toastr, datePipe) {
        ...
        //dateform =new Date();
        this.b = new src_app_Models_IPM_Bon__WEBPACK_IMPORTED_MODULE_11__["IPM_Bon"](0, "", null, null, null, null, null);
        this.bon = new src_app_Models_IPM_Bon_Pharmaceutique__WEBPACK_IMPORTED_MODULE_12__["IPM_Bon_Pharmaceutique"](0, 0, null, "", null, null, "", null, null, null, null, null, null, "");
        this.desactive = false;
