...
var SituationAnnuelleComponent = /** @class */ (function () {
    function SituationAnnuelleComponent(dateAdapter, datepipe, rapportServ) {
        ...
        this.rapportServ = rapportServ;
        this.years = [];
        this.listOfMonths = [{ id: 1, value: 'Javnvier' }, { id: 2, value: 'Février' }, { id: 3, value: 'Mars' }, { id: 4, value: 'Avril' }, { id: 5, value: 'Mai' }, { id: 6, value: 'Juin' },
    ...
    SituationAnnuelleComponent.prototype.getCumulAnnee = function () {
        var _this = this;
        this.rapportServ.getCumulCotisationAnnee(this.selectedYear).subscribe(function (result) {
            var _a, _b;
